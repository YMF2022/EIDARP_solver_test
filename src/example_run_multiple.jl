...
# Start the main loop
function run_multiple(num_cus::Int64, NETWORK::String, vns_params::VNSParameter, instance_idx::Int64)
    instance = "l2-c$num_cus-d2-bt2_$instance_idx"
...
run_multiple(100, "cross", vns_params, 1)
